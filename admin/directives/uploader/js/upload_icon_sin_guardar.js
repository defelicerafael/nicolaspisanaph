 angular.module("upload_icon_sin_guardar",['ngFileUpload'])
    .directive("uploadIconSinGuadar",function(){

        return{
            restrict: "E",
            templateUrl: 'directives/uploader/templates/uploader_icon_sin_guardar.html',
            scope: {
                titulo:"@",
